...
public class LibrarianDashboard extends JPanel {
    ...
    private void addBook(ActionEvent e) {
        ...
        addButton.addActionListener(event -> submitBookDetails(titleField.getText(), authorField.getText(), isbnField.getText()));
        ...
        try {
            ...
            for (Book book : existingBooks) {
                if (book.getIsbn().equals(isbn)) {
                    JOptionPane.showMessageDialog(this, "A book with this ISBN already exists.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
        ...
        removeButton.addActionListener(event -> {
            ...
            if (selectedRow >= 0) {
                ...
                try {
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(removeBookDialog, "Failed to remove the book.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        if (selectedRow >= 0) {
            ...
            if ("Member".equals(userType)) {
                ...
                if (success) {
                    ...
                    JOptionPane.showMessageDialog(null, "Failed to remove user. Please try again.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(null, "Only members can be removed.", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        } else {
