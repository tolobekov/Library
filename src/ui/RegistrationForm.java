        ...
        try {
            ...
            for (User user : users) {
                if (user.getUsername().equals(username)) {
                    JOptionPane.showMessageDialog(this, "This username is already taken.", "Registration Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Failed to register. Please try again.", "Registration Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}